...
In gui, different shadow directions are used in various contexts:
...
Shadow simulates real-world feedback. To make shadows more realistic, gui adopted a three-layer shadow expression method in version 4.0, making shadows softer and more realistic.
