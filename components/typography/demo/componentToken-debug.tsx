...
import { ConfigProvider, Divider, Typography } from 'gzj-ui';
...
const App: React.FC = () => (
  ...
  >
    <Typography>
      ...
      <Paragraph>
        After massive project practice and summaries, gui, a design language for background
